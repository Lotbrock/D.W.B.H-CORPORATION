    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="dwbhApp.cliente.home.createOrEditLabel">
              <Translate contentKey="dwbhApp.cliente.home.createOrEditLabel">Create or edit a Cliente</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : clienteEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label for="tipoDocumento.sigla">
                    <Translate contentKey="dwbhApp.cliente.tipoDocumento">Tipo Documento</Translate>
                  </Label>
                  <AvInput id="cliente-tipoDocumento" type="select" className="form-control" name="tipoDocumentoId">
                    {tipoDocumentos
