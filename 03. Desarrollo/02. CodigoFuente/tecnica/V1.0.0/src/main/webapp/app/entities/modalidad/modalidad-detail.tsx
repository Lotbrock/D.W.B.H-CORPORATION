  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="dwbhApp.modalidad.detail.title">Modalidad</Translate> [<b>{modalidadEntity.id}</b>]
          </h2>
          <dl className="jh-entity-details">
            <dt>
              <span id="nombreModalidad">
                <Translate contentKey="dwbhApp.modalidad.nombreModalidad">Nombre Modalidad</Translate>
              </span>
            </dt>
            <dd>{modalidadEntity.nombreModalidad}</dd>
            <dt>
              <span id="color">
