  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="dwbhApp.resultadoAprendizaje.delete.question">
          <Translate contentKey="dwbhApp.resultadoAprendizaje.delete.question" interpolate={{ id: resultadoAprendizajeEntity.id }}>
