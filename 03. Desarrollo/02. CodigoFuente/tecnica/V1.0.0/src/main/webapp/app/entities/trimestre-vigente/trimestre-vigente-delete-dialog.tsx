  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="dwbhApp.trimestreVigente.delete.question">
          <Translate contentKey="dwbhApp.trimestreVigente.delete.question" interpolate={{ id: trimestreVigenteEntity.id }}>
