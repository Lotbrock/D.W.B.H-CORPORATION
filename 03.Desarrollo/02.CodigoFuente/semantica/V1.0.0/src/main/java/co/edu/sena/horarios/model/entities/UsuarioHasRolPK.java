...
public class UsuarioHasRolPK implements Serializable {
    ...
    public UsuarioHasRolPK(String tipoDocumento, String numeroDocumento, String rol) {
    ...
    public String toString() {
        return "co.edu.sena.horarios.model.entities.UsuarioHasRolPK[ tipoDocumento=" + tipoDocumento + ", numeroDocumento=" + numeroDocumento + ", rol=" + rol + " ]";
    }
