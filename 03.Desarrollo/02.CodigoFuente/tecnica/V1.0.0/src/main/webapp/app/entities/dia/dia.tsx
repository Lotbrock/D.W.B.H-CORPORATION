...
export class Dia extends React.Component<IDiaProps> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="dia-heading">
          <Translate contentKey="dwbhApp.dia.home.title">Dias</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="dwbhApp.dia.home.createLabel">Create new Dia</Translate>
          </Link>
        </h2>
            ...
            <tbody>
              {diaList.map((dia, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{dia.nombreDia}</td>
                  <td>
                    <Translate contentKey={`dwbhApp.Estado.${dia.estado}`} />
                  </td>
