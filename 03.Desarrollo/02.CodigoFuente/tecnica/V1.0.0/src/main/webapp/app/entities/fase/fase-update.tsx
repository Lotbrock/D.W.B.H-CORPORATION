    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="dwbhApp.fase.home.createOrEditLabel">
              <Translate contentKey="dwbhApp.fase.home.createOrEditLabel">Create or edit a Fase</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : faseEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvInput id="fase-proyecto" type="select" className="form-control" name="proyectoId">
                    {proyectos
