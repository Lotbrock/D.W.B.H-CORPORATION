...
export class Sede extends React.Component<ISedeProps> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="sede-heading">
          <Translate contentKey="dwbhApp.sede.home.title">Sedes</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="dwbhApp.sede.home.createLabel">Create new Sede</Translate>
          </Link>
        </h2>
            ...
            <tbody>
              {sedeList.map((sede, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <Translate contentKey={`dwbhApp.Estado.${sede.estado}`} />
                  </td>
