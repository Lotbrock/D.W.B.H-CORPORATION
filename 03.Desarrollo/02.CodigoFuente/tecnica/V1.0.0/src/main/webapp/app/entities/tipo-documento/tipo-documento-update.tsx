    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="dwbhApp.tipoDocumento.home.createOrEditLabel">
              <Translate contentKey="dwbhApp.tipoDocumento.home.createOrEditLabel">Create or edit a TipoDocumento</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
